...
bool ItemBoxObject::Initialize()
{
	...
	{
		m_pTextureComponent->SetTextureAsset(L"../Resource/snowBall.png", L"ItemBox_THROW");
	}
	else if (m_ItemBoxType == eItemBoxType::INSTALLATION)
	{
		m_pTextureComponent->SetTextureAsset(L"../Resource/snowBall.png", L"ItemBox_INSTALL");
	}
	else if (m_ItemBoxType == eItemBoxType::REINFORCED)
	{
		m_pTextureComponent->SetTextureAsset(L"../Resource/snowBall.png", L"ItemBox_REINFORCED");
	}
	...
	m_pBoxCollider->SetCollisionType(COLLISION_TPYE::TRIGGER);
